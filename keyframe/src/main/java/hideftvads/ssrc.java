 ...
 * <tr><td>id</td><td>0x0</td><td>0x8</td><td></td><td>byte[]</td><td>{@link ssrcVisitor#id(ByteBuffer, int[], IntBuffer)}</td></tr>
 *
 * @see hideftvads.ssrc#Atom
 * @see hideftvads.ssrc#id
 *      </table>
 */
public enum ssrc {
    Atom(0x8) {{
    ...
    static void index
        ...
        for (ssrc ssrc_ : values()) {
            String hdr = ssrc_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            ssrc_.subIndex(src, register, stack);
        }
    }
