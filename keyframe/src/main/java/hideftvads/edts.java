 ...
 * <tr><td>elst</td><td>0xc</td><td>0x8</td><td></td><td>byte[]</td><td>{@link hideftvads.elst}</td></tr>
 *
 * @see hideftvads.edts#Atom
 * @see hideftvads.edts#elst
 *      </table>
 */
public enum edts {
    Atom(0x8) {{
        ...
        ___subrecord___ = hideftvads.elst.class;
    }};
    /**
    ...
    static void index
        ...
        for (edts edts_ : values()) {
            String hdr = edts_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            edts_.subIndex(src, register, stack);
        }
    }
