 ...
 * <tr><td>clippingRegion$asAtom</td><td>0x8</td><td>0x8</td><td></td><td>long</td><td>{@link clipVisitor#clippingRegion$asAtom(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see hideftvads.clip#Atom
 * @see hideftvads.clip#clippingRegion$asAtom
 * </table>
 */
public enum clip { 
Atom(0x8)	{{
...
,clippingRegion$asAtom(0x8);
    ...
    static void index
        ...
        for (clip clip_ : values()) {
            String hdr = clip_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            clip_.subIndex(src, register, stack);
        }
    }
