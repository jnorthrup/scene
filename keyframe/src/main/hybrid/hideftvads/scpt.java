 ...
 * <tr><td>id</td><td>0x0</td><td>0x8</td><td></td><td>byte[]</td><td>{@link scptVisitor#id(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see hideftvads.scpt#Atom
 * @see hideftvads.scpt#id
 * </table>
 */
public enum scpt { 
Atom(0x8)	{{
...
,id;
    ...
    static void index
        ...
        for (scpt scpt_ : values()) {
            String hdr = scpt_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            scpt_.subIndex(src, register, stack);
        }
    }
