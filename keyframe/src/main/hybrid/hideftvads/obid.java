 ...
 * <tr><td>id</td><td>0x0</td><td>0x8</td><td></td><td>byte[]</td><td>{@link obidVisitor#id(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see hideftvads.obid#Atom
 * @see hideftvads.obid#id
 * </table>
 */
public enum obid { 
Atom(0x8)	{{
...
,id;
    ...
    static void index
        ...
        for (obid obid_ : values()) {
            String hdr = obid_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            obid_.subIndex(src, register, stack);
        }
    }
