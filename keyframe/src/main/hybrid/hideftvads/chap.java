 ...
 * <tr><td>id</td><td>0x0</td><td>0x8</td><td></td><td>byte[]</td><td>{@link chapVisitor#id(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see hideftvads.chap#Atom
 * @see hideftvads.chap#id
 * </table>
 */
public enum chap { 
Atom(0x8)	{{
...
,id;
    ...
    static void index
        ...
        for (chap chap_ : values()) {
            String hdr = chap_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            chap_.subIndex(src, register, stack);
        }
    }
