 ...
 * <tr><td>$00$00in</td><td>0x10</td><td>0x8</td><td></td><td>byte[]</td><td>{@link hideftvads.$00$00in}</td></tr>
 * <tr><td>$00$00ins</td><td>0x0</td><td>0x18</td><td></td><td>byte[]</td><td>{@link imapVisitor#$00$00ins(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see hideftvads.imap#Atom
 * @see hideftvads.imap#$00$00in
 * @see hideftvads.imap#$00$00ins
 * </table>
 */
public enum imap { 
Atom(0x8)	{{
...
,$00$00in(0x10)	{{
		___subrecord___=hideftvads.$00$00in.class;
	}}
,$00$00ins;
	/**
    ...
    static void index
        ...
        for (imap imap_ : values()) {
            String hdr = imap_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            imap_.subIndex(src, register, stack);
        }
    }
