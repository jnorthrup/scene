 ...
 * <tr><td>version</td><td>0x1</td><td>0x8</td><td></td><td>byte</td><td>{@link kmatVisitor#version(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td>flags</td><td>0x3</td><td>0x9</td><td></td><td>byte[]</td><td>{@link kmatVisitor#flags(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td>matteImageDeceiptionStructure</td><td>0x0</td><td>0xc</td><td></td><td>byte[]</td><td>{@link kmatVisitor#matteImageDeceiptionStructure(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td>matteData</td><td>0x0</td><td>0xc</td><td></td><td>byte[]</td><td>{@link kmatVisitor#matteData(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see hideftvads.kmat#Atom
 * @see hideftvads.kmat#version
 * @see hideftvads.kmat#flags
 * @see hideftvads.kmat#matteImageDeceiptionStructure
 * @see hideftvads.kmat#matteData
 * </table>
 */
public enum kmat { 
Atom(0x8)	{{
...
,version(0x1),flags(0x3),matteImageDeceiptionStructure,matteData;
	/**
    ...
    static void index
        ...
        for (kmat kmat_ : values()) {
            String hdr = kmat_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            kmat_.subIndex(src, register, stack);
        }
    }
