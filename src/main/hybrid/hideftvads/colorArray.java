 ...
 * <tr><td>o</td><td>0x4</td><td>0x0</td><td></td><td>int</td><td>{@link colorArrayVisitor#o(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td>r</td><td>0x4</td><td>0x4</td><td></td><td>int</td><td>{@link colorArrayVisitor#r(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td>g</td><td>0x4</td><td>0x8</td><td></td><td>int</td><td>{@link colorArrayVisitor#g(ByteBuffer, int[], IntBuffer)}</td></tr>
 * <tr><td>b</td><td>0x4</td><td>0xc</td><td></td><td>int</td><td>{@link colorArrayVisitor#b(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see hideftvads.colorArray#o
 * @see hideftvads.colorArray#r
 * @see hideftvads.colorArray#g
 * @see hideftvads.colorArray#b
 * </table>
 */
public enum colorArray { 
o(0x4),r(0x4),g(0x4),b(0x4);
    ...
    /** colorArray templated Byte Struct 
     * @param dimensions [0]=___size___,[1]= forced ___seek___
     */
	colorArray (int... dimensions) {
    ...
    static void index
        ...
        for (colorArray colorArray_ : values()) {
            String hdr = colorArray_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            colorArray_.subIndex(src, register, stack);
        }
    }
