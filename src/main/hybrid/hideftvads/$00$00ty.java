 ...
 * <tr><td>inputType</td><td>0x0</td><td>0x8</td><td></td><td>byte[]</td><td>{@link $00$00tyVisitor#inputType(ByteBuffer, int[], IntBuffer)}</td></tr>
 * 
 * @see hideftvads.$00$00ty#Atom
 * @see hideftvads.$00$00ty#inputType
 * </table>
 */
public enum $00$00ty { 
Atom(0x8)	{{
...
,inputType;
	public java.lang.Class hideftvads.$00$00ty.___valueclass___;
    ...
    /** $00$00ty templated Byte Struct 
     * @param dimensions [0]=___size___,[1]= forced ___seek___
     */
	$00$00ty (int... dimensions) {
    ...
    static void index
        ...
        for ($00$00ty $00$00ty_ : values()) {
            String hdr = $00$00ty_.name();
            System.err.println("hdr:pos " + hdr + ':' + stack.position());
            $00$00ty_.subIndex(src, register, stack);
        }
    }
