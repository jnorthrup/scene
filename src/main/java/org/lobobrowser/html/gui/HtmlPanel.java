...
public class HtmlPanel extends JComponent implements FrameContext {
    ...
    public static void main(String... a) throws MalformedURLException {
        ...
        contentPane.add(df, BorderLayout.CENTER);
        ...
        final SimpleHtmlRendererContext context = new SimpleHtmlRendererContext(hpanel);
        hpanel.setHtml("<html><body><p>hi</p><body></html>", "/", context);

        internalFrame.setContentPane(new JScrollPane(hpanel));
